...
def attendance():
    ...
    data = [atten for atten in attendance_data if (ending_formatted_time > atten[1] > starting_formatted_time)]
    ...
    return render_template('index.html', selected_date=selected_date,selected_time=starting_selected_time, attendance_data=data)
